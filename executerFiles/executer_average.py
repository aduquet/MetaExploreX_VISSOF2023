...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = average(testInput)
        output_MR1 = average(MR1)
        output_MR2 = average(MR2)
        output_MR3 = average(MR3)
        output_MR5 = average(MR5)
        output_MR6 = average(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = average(MR4)
