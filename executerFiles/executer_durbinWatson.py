...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = durbinWatson(testInput)
        output_MR1 = durbinWatson(MR1)
        output_MR2 = durbinWatson(MR2)
        output_MR3 = durbinWatson(MR3)
        output_MR5 = durbinWatson(MR5)
        output_MR6 = durbinWatson(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = durbinWatson(MR4)
