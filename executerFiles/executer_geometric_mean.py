...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = geometric_mean(testInput)
        output_MR1 = geometric_mean(MR1)
        output_MR2 = geometric_mean(MR2)
        output_MR3 = geometric_mean(MR3)
        output_MR5 = geometric_mean(MR5)
        output_MR6 = geometric_mean(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = geometric_mean(MR4)
