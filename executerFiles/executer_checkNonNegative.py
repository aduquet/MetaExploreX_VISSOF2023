...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = checkNonNegative(testInput)
        output_MR1 = checkNonNegative(MR1)
        output_MR2 = checkNonNegative(MR2)
        output_MR3 = checkNonNegative(MR3)
        output_MR5 = checkNonNegative(MR5)
        output_MR6 = checkNonNegative(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = checkNonNegative(MR4)
