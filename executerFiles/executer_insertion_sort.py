...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = insertion_sort(testInput)
        output_MR1 = insertion_sort(MR1)
        output_MR2 = insertion_sort(MR2)
        output_MR3 = insertion_sort(MR3)
        output_MR5 = insertion_sort(MR5)
        output_MR6 = insertion_sort(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = insertion_sort(MR4)
