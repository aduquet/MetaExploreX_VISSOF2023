...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = variance(testInput)
        output_MR1 = variance(MR1)
        output_MR2 = variance(MR2)
        output_MR3 = variance(MR3)
        output_MR5 = variance(MR5)
        output_MR6 = variance(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = variance(MR4)
