...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = product(testInput)
        output_MR1 = product(MR1)
        output_MR2 = product(MR2)
        output_MR3 = product(MR3)
        output_MR5 = product(MR5)
        output_MR6 = product(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = product(MR4)
