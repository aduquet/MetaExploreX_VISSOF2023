...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = cnt_zeros(testInput)
        output_MR1 = cnt_zeros(MR1)
        output_MR2 = cnt_zeros(MR2)
        output_MR3 = cnt_zeros(MR3)
        output_MR5 = cnt_zeros(MR5)
        output_MR6 = cnt_zeros(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = cnt_zeros(MR4)
