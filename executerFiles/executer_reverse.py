...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = reverse(testInput)
        output_MR1 = reverse(MR1)
        output_MR2 = reverse(MR2)
        output_MR3 = reverse(MR3)
        output_MR5 = reverse(MR5)
        output_MR6 = reverse(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = reverse(MR4)
