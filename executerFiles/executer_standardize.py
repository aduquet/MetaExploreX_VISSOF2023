...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = standardize(testInput)
        output_MR1 = standardize(MR1)
        output_MR2 = standardize(MR2)
        output_MR3 = standardize(MR3)
        output_MR5 = standardize(MR5)
        output_MR6 = standardize(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = standardize(MR4)
