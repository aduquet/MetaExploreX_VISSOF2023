...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = safeNorm(testInput)
        output_MR1 = safeNorm(MR1)
        output_MR2 = safeNorm(MR2)
        output_MR3 = safeNorm(MR3)
        output_MR5 = safeNorm(MR5)
        output_MR6 = safeNorm(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = safeNorm(MR4)
