...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = entropy(testInput)
        output_MR1 = entropy(MR1)
        output_MR2 = entropy(MR2)
        output_MR3 = entropy(MR3)
        output_MR5 = entropy(MR5)
        output_MR6 = entropy(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = entropy(MR4)
