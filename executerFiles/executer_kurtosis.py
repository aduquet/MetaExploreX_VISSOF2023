...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = kurtosis(testInput)
        output_MR1 = kurtosis(MR1)
        output_MR2 = kurtosis(MR2)
        output_MR3 = kurtosis(MR3)
        output_MR5 = kurtosis(MR5)
        output_MR6 = kurtosis(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = kurtosis(MR4)
