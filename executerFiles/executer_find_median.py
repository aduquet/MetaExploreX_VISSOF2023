...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = find_median(testInput)
        output_MR1 = find_median(MR1)
        output_MR2 = find_median(MR2)
        output_MR3 = find_median(MR3)
        output_MR5 = find_median(MR5)
        output_MR6 = find_median(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = find_median(MR4)
