...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = array_copy(testInput)
        output_MR1 = array_copy(MR1)
        output_MR2 = array_copy(MR2)
        output_MR3 = array_copy(MR3)
        output_MR5 = array_copy(MR5)
        output_MR6 = array_copy(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = array_copy(MR4)
