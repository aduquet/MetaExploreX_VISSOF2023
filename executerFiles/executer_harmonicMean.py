...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = harmonicMean(testInput)
        output_MR1 = harmonicMean(MR1)
        output_MR2 = harmonicMean(MR2)
        output_MR3 = harmonicMean(MR3)
        output_MR5 = harmonicMean(MR5)
        output_MR6 = harmonicMean(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = harmonicMean(MR4)
