...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = bubble(testInput)
        output_MR1 = bubble(MR1)
        output_MR2 = bubble(MR2)
        output_MR3 = bubble(MR3)
        output_MR5 = bubble(MR5)
        output_MR6 = bubble(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = bubble(MR4)
