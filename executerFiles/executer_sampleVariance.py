...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = sampleVariance(testInput)
        output_MR1 = sampleVariance(MR1)
        output_MR2 = sampleVariance(MR2)
        output_MR3 = sampleVariance(MR3)
        output_MR5 = sampleVariance(MR5)
        output_MR6 = sampleVariance(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = sampleVariance(MR4)
