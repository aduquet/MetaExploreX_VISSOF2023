...
def dataExecution(inputTestID, testData, outputData, outputchecker, pathdata, pathChecker):
    ...
    for i in range(0, len(testData)):
        ...
        output_testData = checkPositive(testInput)
        output_MR1 = checkPositive(MR1)
        output_MR2 = checkPositive(MR2)
        output_MR3 = checkPositive(MR3)
        output_MR5 = checkPositive(MR5)
        output_MR6 = checkPositive(MR6)

        if 'N/A' in MR4:
            output_MR4 = 'd/0'
        else:
            output_MR4 = checkPositive(MR4)
